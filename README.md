...
* Relative to SPY's unit beta, ***all except IBM*** has ***above-one*** betas, reflecting ***higher volatility/fluctuations*** relative to the overall market.
...
* ***The implication:  ***Investment risks can be potentially reduced or diversified away by building a well-balanced portfolio comprising the 5 tech stocks. This answers the CFO's concerns with managing the market risks from investing in highly volatile tech stocks!*** 
...
* By simulating various combinations of asset weights, the Simulator interactively generates the ***weighted portfolio returns and volatilities, factoring daily-refreshed pairwise correlation structures and realized stock returns.***

* ***Regardless of the asset weights permutations, the simulated outcomes consistently prove that the portfolio volatilities tend to be much lower than those of the individual counters (except for IBM which is relatively low-risk on a standalone basis).***

### **Key Takeaways:** 

#### 1. The tech stocks are high-performing stocks with promising growth upside potential.

#### 2. Common systematic influences aside, the underlying correlation structures - positive but only moderately strong - suggests presence of favourable risk-reducing portfolio diversification effects.
...
Armed with the tools we have painstakingly designed and operationalised, it's then up to the CFO and the Finance Team to leverage them to convince the Board on the most optimal investment strategy to grow fiscal reserves, going forward.